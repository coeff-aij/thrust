...
// The generic `Map` adapter used at a call site, with a `next` ensures that spells the produced
// item as the literal `Seq::singleton(i)`.
//
        ...
        "(and
            ...
            (forall ((i a3))
                (=>
                    ...
                    (q_pre_next_95f795715d771a34ecce58bad9cfc92a<a1>
    ...
    fn step(self, item: Self::Item, dist: Self) -> bool {
        ...
        "(exists ((i a3))
            (and
                ...
                (q_post_next_95f795715d771a34ecce58bad9cfc92a<a1>
                    (tuple_proj<a0-a1>.1 self_)
                    i
                    item
                )
