// FIXME: Timeout(60s) from PCSAT (also at 300s); `match &mut self.iter` on an Option field. The `Some(ref mut it)` form and the assign variant verify.
//@compile-flags: -C debug-assertions=off
//@rustc-env: THRUST_SOLVER=tests/thrust-pcsat-wrapper THRUST_SOLVER_TIMEOUT_SECS=60 COAR_IMAGE=coar:latest

// Probe: reborrowing an Option<I> field with `match &mut self.iter` (the Fuse pattern).
