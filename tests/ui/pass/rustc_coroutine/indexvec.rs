...
impl<I: Idx, T> IndexVec<I, T> {
    ...
    #[thrust_macros::ensures(forall(|k: Int| !(0 <= k && k < n) || result.array[k] == elem))]
    ...
    #[thrust::trusted]
    #[thrust_macros::requires(true)]
    #[thrust_macros::ensures(result == (*self).length)]
    ...
    #[thrust::trusted]
    #[thrust_macros::requires(true)]
    #[thrust_macros::ensures((result == true) == ((*self).length == 0))]
    ...
    #[inline]
    #[thrust::trusted]
    #[thrust_macros::requires(<I as Idx>::can_new((*self).length))]
    #[thrust_macros::ensures(<I as Idx>::index_is(result, (*self).length))]
    ...
    #[thrust::trusted]
    #[thrust_macros::requires(<I as Idx>::can_new((*self).length))]
    #[thrust_macros::ensures(!self == thrust_models::model::Seq { array: (*self).array.store((*self).length, d), length: (*self).length + 1 })]
    #[thrust_macros::ensures(<I as Idx>::index_is(result, (*self).length))]
    ...
    #[inline]
    #[thrust::trusted]
    #[thrust_macros::requires(forall(|i: Int| !<I as Idx>::index_is(index, i) || (0 <= i && i < (*self).length)))]
    #[thrust_macros::ensures(forall(|i: Int| !<I as Idx>::index_is(index, i) || *result == (*self).array[i]))]
        ...
        thrust_macros::invariant!(
            |v: IndexVec<usize, i64>,
             ...
             elem: thrust_models::FnParam<i64>|
                v.length == i
                    && i <= n.at_entry()
                    && forall(|k: Int| !(0 <= k && k < i) || v.array[k] == elem.at_entry())
        );
        v.push(elem);
        i += 1;
    }
