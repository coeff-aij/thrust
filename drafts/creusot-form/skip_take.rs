...
// trait and `Take` are `take_law.rs`'s (laws as callable `#[law]`s); `Skip` is `traits/skip.rs`
// rewritten to Rust-syntax predicate bodies, stacked as `Skip<Take<I>>` and used at a generic `I`.
